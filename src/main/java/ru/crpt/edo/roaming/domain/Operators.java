...
public class Operators implements Serializable {
    ...
    private TransportPackage operatorId;
    ...
    public TransportPackage getOperatorId() {
        return operatorId;
    }

    public Operators operatorId(TransportPackage transportPackage) {
        this.operatorId = transportPackage;
        return this;
    }

    public void setOperatorId(TransportPackage transportPackage) {
        this.operatorId = transportPackage;
    }
