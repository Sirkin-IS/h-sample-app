...
public class TransportPackage implements Serializable {
    ...
    @OneToOne(mappedBy = "transportPackageId")
    @JsonIgnore
    private BadIncomingTransportPackage transportPackageId;

    @ManyToOne
    @JsonIgnoreProperties("transportPackageIds")
    private TransportPackageRepeat transportPackageId;
    ...
    public BadIncomingTransportPackage getTransportPackageId() {
        return transportPackageId;
    }

    public TransportPackage transportPackageId(BadIncomingTransportPackage badIncomingTransportPackage) {
        this.transportPackageId = badIncomingTransportPackage;
        return this;
    }

    public void setTransportPackageId(BadIncomingTransportPackage badIncomingTransportPackage) {
        this.transportPackageId = badIncomingTransportPackage;
    }

    public TransportPackageRepeat getTransportPackageId() {
        return transportPackageId;
    }

    public TransportPackage transportPackageId(TransportPackageRepeat transportPackageRepeat) {
        this.transportPackageId = transportPackageRepeat;
        return this;
    }

    public void setTransportPackageId(TransportPackageRepeat transportPackageRepeat) {
        this.transportPackageId = transportPackageRepeat;
    }
