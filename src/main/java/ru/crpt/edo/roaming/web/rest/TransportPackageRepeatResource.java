...
/**
 * REST controller for managing {@link ru.crpt.edo.roaming.domain.TransportPackageRepeat}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TransportPackageRepeatResource {
    ...
    private static final String ENTITY_NAME = "sampleAppTransportPackageRepeat";
