...
import ru.crpt.edo.roaming.SampleApp;
import ru.crpt.edo.roaming.domain.DocumentHistory;
import ru.crpt.edo.roaming.repository.DocumentHistoryRepository;
import ru.crpt.edo.roaming.web.rest.errors.ExceptionTranslator;
...
import static ru.crpt.edo.roaming.web.rest.TestUtil.createFormattingConversionService;
...
public class DocumentHistoryResourceIT {
    ...
    public void createDocumentHistory() throws Exception {
        ...
        assertThat(testDocumentHistory.getCreatedAt()).isEqualTo(DEFAULT_CREATED_AT);
    }
    ...
    public void checkCreatedAtIsRequired() throws Exception {
        int databaseSizeBeforeTest = documentHistoryRepository.findAll().size();
        // set the field null
        documentHistory.setCreatedAt(null);
    ...
    public void updateDocumentHistory() throws Exception {
        ...
        assertThat(testDocumentHistory.getCreatedAt()).isEqualTo(UPDATED_CREATED_AT);
    }
